		...
		<div class="table-responsive">
			<table class="table table-bordered table-striped table-hover table-condensed">
				<tbody>
					...
					<tr><th class="u-data">NAME: <?php echo $_SESSION['name']; ?></th><th class="u-data">ROLL NO: <?php echo $_SESSION['roll']; ?></th></tr>			
			...
			<table class="table table-bordered table-striped table-hover table-condensed">
				<tbody>
		    		...
		    		<tr><th class="u-data">SGPA</th><th class="u-data"><?php echo $sgpa;  if($p){ echo " <i>*Partial Result</i>";}?></th></tr>
